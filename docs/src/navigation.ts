...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    dir: 'guide',
    items: [
      { title: 'Tips and Tricks', slug: 'guide/tips-and-tricks' },
      { title: 'Sample Prompts', slug: 'guide/sample-prompts' },
      { title: 'FAQ', slug: 'guide/faq' },
      { title: 'Build autonomous agent', slug: 'guide/build-autonomous-agent' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Built-in roles', slug: 'features/built-in-roles' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'VS Code troubleshooting', slug: 'reference/vscode-troubleshooting' },
    ],
  },
  {
    title: 'Scenarios',
