...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: 'Known Limitations', slug: 'get-started/known-limitations' },
    ],
  },
  {
    title: 'Guide',
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Session Model', slug: 'concepts/session-model' },
      { title: 'Repo Anatomy', slug: 'concepts/repo-anatomy' },
